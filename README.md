...
Sou **Técnico Agrícola e Gestor em Agronegócios**, e hoje atuo como **especialista em Drones de Pulverização DJI Agriculture** . Atuei nas área de insumos em geral, desenvolvimento de produtos, gestão de equipe e etc. Não venho da área de desenvolvimento de software — mas de um tempo pra cá comecei a criar minhas próprias ferramentas, automações e aplicativos pra resolver problemas reais do meu trabalho no dia a dia.
